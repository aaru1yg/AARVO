...
const Deals = () => {
  ...
  // Get product with biggest discount
  const dealProduct = products.find(p => p.originalPrice && p.originalPrice > p.price) || products[0];
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 relative z-10">
                ...
                {[
                  ...
                  <div key={unit.label} className="flex flex-col items-center">
                    <motion.div
                      ...
                      className="w-20 h-20 bg-white/10 rounded-2xl flex items-center justify-center text-3xl font-black border border-white/20">
            ...
            <div className="relative w-full lg:w-1/2 aspect-square max-w-[500px]">
              <motion.div
                ...
                <img
                  src={dealProduct?.image || '/images/gadget-1.jpg'}
                  alt="Deal Item"
